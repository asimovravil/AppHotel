...
final class LuxeTableViewCell: UITableViewCell {
    ...
    private lazy var cardLuxeView: UIView = {
        let view = UIView()
    ...
    private lazy var descriptionNumberLabel: UILabel = {
        let label = UILabel()
        label.text = "Люкс номер с видом на море"
    ...
    private func setupViews() {
        [cardLuxeView, imageCarousel, descriptionNumberLabel, cardAllInclusiveView, cardAllInclusiveLabel, cardAirConditionerView, cardAirConditionerLabel, cardDetailView, cardDetailLabel, arrowImageView, priceLabel, descriptionPriceLabel, choiceNumberButton].forEach {
    ...
    private func setupConstraints() {
        cardLuxeView.snp.makeConstraints { make in
